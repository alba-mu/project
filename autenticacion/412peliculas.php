...
$page_title = "Ejercicio Login-Logout — Listado de Películas";
    ...
    <?php else: ?>
        ...
        <section class="mb-4">
            ...
            <div class="p-5 bg-light rounded-4 shadow-soft">
                <h1 class="fw-bold text-mediumslateblue mb-4 text-center">Listado de Películas</h1>
                <ul class="list-group list-group-flush w-75 mx-auto">
                    <?php foreach ($_SESSION['peliculas'] as $pelicula): ?>
                        <li class="list-group-item"><?= htmlspecialchars($pelicula) ?></li>
                    <?php endforeach; ?>
                </ul>
            </div>
        </section>
